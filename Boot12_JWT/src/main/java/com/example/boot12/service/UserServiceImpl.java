...
import com.example.boot12.exception.PasswordException;
...
public class UserServiceImpl implements UserService{
	@Autowired
	private UserDao dao;
	// SecurityConfig 클래스에서 bean으로 등록된 객체 주입 받기 
	@Autowired
	...
	public void getInfo(Model model) {
		// 개인 정보를 본다는 것은 이미 로그인을 한 상태인데 로그인된 userName 은 어떻게 얻어낼까?
		// Spring Security의 기능을 통해서 얻어낸다.
		String userName = SecurityContextHolder.getContext().getAuthentication().getName();
		// 로그인 된 userName을 이용해서 UserDto 객체를 dao를 통해서 얻어낸다.
